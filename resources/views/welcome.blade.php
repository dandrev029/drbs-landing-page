                ...
                <div class="col-lg-8 mx-auto text-center">
                    <div class="hero-content" data-aos="fade-up">
                        <span class="badge bg-primary-gradient mb-3 px-4 py-2 rounded-pill">
                            <i class="bi bi-lightning-charge-fill me-2"></i>Reliable & Fast
                        </span>
                        <h1 class="display-2 fw-bold text-white mb-4">
                            High-Speed Internet<br>
                            <span class="text-gradient">Built for Your Home</span>
                        </h1>
                        <p class="lead text-white-50 mb-5 fs-4">
                            Experience blazing-fast internet tailored for condominium living.<br>
